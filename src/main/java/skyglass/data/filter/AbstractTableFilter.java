...
public abstract class AbstractTableFilter<T, F> extends AbstractBaseTableFilter<T, F> implements ITableFilter<T, F> {
	...
	protected AbstractTableFilter(JunctionType junctionType) {
		super(junctionType);
