...
public class AbstractBaseHttpTableFilterWrapper<T, F> implements IBaseTableFilter<T, F> {
	
	private IBaseTableFilter<T, ?> filter;
	
	protected HttpServletRequest request;
	
	protected String[] searchFields;	
	
	public AbstractBaseHttpTableFilterWrapper(IBaseTableFilter<T, ?> filter, HttpServletRequest request) {
		this.filter = filter;		
	...
	protected IBaseTableFilter<T, ?> getParentFilter() {
		return filter;
	}
