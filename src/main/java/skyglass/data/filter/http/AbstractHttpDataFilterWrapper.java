...
public class AbstractHttpDataFilterWrapper<T, F> extends AbstractBaseHttpDataFilter<T, F>  {
	
	protected IDataFilter<T, ?> filter;
	...
	public AbstractHttpDataFilterWrapper(IDataFilter<T, ?> filter, 
